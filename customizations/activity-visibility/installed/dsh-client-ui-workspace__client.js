	...
	factory: (require) => {
		...
		function deriveGroups(list, workspaces, archivedSessionIds, view) {
			...
			for (const g of groupByWorkspace(list, workspaces, archived, view.ungroupedOrder)) {
				...
				for (const s of g.sessions) {
					if (s.blank) continue;
					if (s.pendingInteraction !== void 0) pendingCount += 1;
					if (s.running === true) runningCount += 1;
		...
		*/
		...
		var Rows_module_css_default = {
			...
			"activityMeta": "YDXeBa_activityMeta",
		...
		function ProjectRowItem({ group, onToggle, onCreate, actions, drag, t }) {
			...
			const ownRow = (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					(row.runningCount > 0 || row.pendingCount > 0) && (0, react_jsx_runtime.jsxs)("span", {
						className: Rows_module_css_default.activityMeta,
						children: [row.pendingCount > 0 && (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.StateDot, { state: "warning" }), (0, react_jsx_runtime.jsx)("span", { children: String(row.pendingCount) })] }), row.runningCount > 0 && (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.StateDot, { state: "ongoing" }), (0, react_jsx_runtime.jsx)("span", { children: String(row.runningCount) })] })]
					}),
		...
		*/
		...
		const zh = {
			...
			"status.running": "进行中",
			"group.activity.running": "{n} 个运行中",
			"group.activity.pending": "{n} 个等待操作",
		...
		const en = {
			...
			"group.activity.running": "{n} running",
			"group.activity.pending": "{n} waiting for you",
